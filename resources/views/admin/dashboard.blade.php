    ...
    <div class="flex items-start justify-start scrollable-container max-w-full max-h-[60vh]">
        <table class="display table-fixed dataTables_wrapper " id="table">
            <x-caise.C.caise-thead>
                <x-caise.C.caise-th style="width: 50px;">id</x-caise.C.caise-th>
                <x-caise.C.caise-th style="width: 30px;">first_name</x-caise.C.caise-th>
                <x-caise.C.caise-th style="width: 40px;">last_name</x-caise.C.caise-th>
                <x-caise.C.caise-th style="width: 40px;">role_name</x-caise.C.caise-th>
                <x-caise.C.caise-th style="width: 40px;">cellule_name</x-caise.C.caise-th>
                <x-caise.C.caise-th position="right" style="width: 50px; ">email</x-caise.C.caise-th>
                <x-caise.C.caise-th position="right" style="width: 50px; ">ProfilePreview</x-caise.C.caise-th>
            </x-caise.C.caise-thead>
